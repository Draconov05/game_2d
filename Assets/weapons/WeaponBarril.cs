...
public class WeaponBarril : MonoBehaviour
{
    ...
    public void fire(float angle){
        ...
        GameObject bullet_inner = Instantiate(bullet, new Vector3(transform.position.x + (0.45f * Player.transform.localScale.x),Player.transform.position.y,transform.position.z),transform.rotation);
